...
export const ALL_ARTICLES: Article[] = [
  ...
  },
  {
    ...
    dateISO: "2026-08-27",
    readTime: "6 นาที",
    img: "/assets/tablet-english-classroom-cover.webp",
    alt: "ใช้แท็บเล็ตเครื่องเดียวสอนภาษาอังกฤษระดับประถมศึกษา บรรยากาศจริงจากห้องเรียนกับสื่อการสอนคุณคูล",
    href: "/blog/tablet-english-classroom",
    excerpt:
      "ภาพบรรยากาศจริงจากห้องเรียนประถมศึกษาที่มีแท็บเล็ตเพียงเครื่องเดียว ครูมิเรอร์ขึ้นจอหน้าห้องแล้วให้เด็กผลัดกันมาตอบ ทั้งห้องได้คิดตามและครูสอนง่ายขึ้น",
    linksTool: { label: "เกมคำศัพท์ภาษาอังกฤษ", href: "/media/english/vocabulary-arcade" },
  },
  {
    ...
    dateISO: "2026-08-25",
    readTime: "9 นาที",
    img: "/assets/mathematics-games-cover.webp",
    alt: "เกมและกิจกรรมคณิตศาสตร์ ป.1-ป.6 สำหรับครู",
    href: "/blog/mathematics-games",
    excerpt:
      "เกมคณิตศาสตร์ที่เปิดจากจอหน้าชั้นได้ทันที ตั้งแต่บวกลบด้วยเส้นจำนวนสำหรับ ป.1 ถึงคิดเลขเร็วและเศษส่วนสำหรับชั้นโต พร้อมวิธีจัดให้ทั้งห้องได้คิดจริง",
    linksTool: { label: "สื่อคณิตศาสตร์", href: "/media/mathematics" },
  },
  {
    ...
    dateISO: "2026-08-25",
    readTime: "9 นาที",
    img: "/assets/science-lab-activities-cover.webp",
    alt: "กิจกรรมทดลองวิทยาศาสตร์บนจอสำหรับห้องเรียนที่ไม่มีอุปกรณ์",
    href: "/blog/science-lab-activities",
    excerpt:
      "การทดลองที่สาธิตได้ด้วยของในครัวราคาไม่กี่บาท พร้อมสื่อจำลองสำหรับเรื่องที่ทดลองจริงในห้องไม่ได้ อย่างความหนาแน่นและการเคลื่อนที่",
    linksTool: { label: "สื่อวิทยาศาสตร์", href: "/media/science" },
  },
  {
    ...
    dateISO: "2026-08-25",
    readTime: "9 นาที",
    img: "/assets/thai-reading-writing-activities-cover.webp",
    alt: "กิจกรรมสอนอ่านเขียนภาษาไทย ป.1 พยัญชนะ สระ และการประสมคำ",
    href: "/blog/thai-reading-writing-activities",
    excerpt:
      "เด็กที่อ่านไม่ออกส่วนใหญ่ติดที่ตำแหน่งสระ ไม่ใช่ที่พยัญชนะ กิจกรรมชุดนี้จึงไล่จากรูปและเสียงพยัญชนะไปสู่การประสมคำ พร้อมสื่อที่มีเสียงอ่านทุกคำ",
    linksTool: { label: "สื่อภาษาไทย", href: "/media/thai" },
  },
  {
    ...
    dateISO: "2026-08-25",
    readTime: "9 นาที",
    img: "/assets/weather-seasons-english-cover.webp",
    alt: "กิจกรรมสอนคำศัพท์สภาพอากาศและฤดูกาลภาษาอังกฤษสำหรับเด็กประถม",
    href: "/blog/weather-seasons-english",
    excerpt:
      "พาเด็กข้ามจากการจำคำเดี่ยวไปสู่การพูดเป็นประโยค พร้อมวิธีอธิบายเรื่องสี่ฤดูในหนังสือกับสามฤดูของไทยไม่ให้นักเรียนสับสน",
    linksTool: { label: "เปิด Weather & Seasons", href: "/media/english/weather-seasons" },
  },
  {
    ...
    dateISO: "2026-08-25",
    readTime: "9 นาที",
    img: "/assets/social-studies-games-cover.webp",
    alt: "เกมและกิจกรรมสังคมศึกษา ป.3-ป.6 เรื่องอาเซียนและกฎหมายใกล้ตัว",
    href: "/blog/social-studies-games",
    excerpt:
      "กิจกรรมที่พาเด็กข้ามจากการท่องชื่อประเทศและมาตรากฎหมาย ไปสู่การวิเคราะห์สถานการณ์จริงและอธิบายเหตุผลของตัวเองได้",
    linksTool: { label: "สื่อสังคมศึกษา", href: "/media/social-studies" },
  },
  {
    ...
    dateISO: "2026-08-25",
    readTime: "8 นาที",
    img: "/assets/classroom-timer-activities-cover.webp",
    alt: "การใช้เครื่องจับเวลาในห้องเรียนเพื่อคุมเวลาแต่ละกิจกรรม",
    href: "/blog/classroom-timer-activities",
    excerpt:
      "คาบเรียนไม่พอมักไม่ได้เกิดจากเนื้อหามากเกินไป แต่เกิดจากแต่ละช่วงยืดออกทีละสองสามนาที รวม 8 วิธีย้ายหน้าที่คุมเวลาไปไว้บนจอที่ทุกคนเห็น",
    linksTool: { label: "เปิดเครื่องจับเวลา", href: "/timer" },
  },
  {
    ...
    dateISO: "2026-08-25",
    readTime: "8 นาที",
    img: "/assets/random-question-activities-cover.webp",
    alt: "กิจกรรมสุ่มคำถามในห้องเรียนให้นักเรียนทุกคนมีส่วนร่วม",
    href: "/blog/random-question-activities",
    excerpt:
      "ปัญหาของการยกมือตอบคือคนที่ควรได้ฝึกกลับไม่ได้ฝึก รวม 7 รูปแบบการสุ่มและกติกาที่ทำให้การถูกสุ่มเป็นเรื่องปกติ ไม่ใช่การจับผิดหน้าชั้น",
    linksTool: { label: "เปิดสุ่มคำถาม", href: "/random-question" },
  },
  {
