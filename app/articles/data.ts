...
export const ALL_ARTICLES: Article[] = [
  ...
  },
  {
    ...
    dateISO: "2026-08-05",
    readTime: "7 นาที",
    img: "/assets/khuncool-teacher-tools-cover.webp",
    alt: "แนะนำเว็บไซต์ KhunCool รวมเครื่องมือครูและสื่อการสอนออนไลน์ใช้ฟรี",
    href: "/blog/khuncool-teacher-tools",
    excerpt: "รู้จัก KhunCool เว็บไซต์เครื่องมือครูภาษาไทย พร้อมแนวทางเริ่มใช้ เลือกเครื่องมือ และดูแลข้อมูลนักเรียนอย่างเหมาะสม",
    linksTool: { label: "รู้จัก KhunCool", href: "/about" },
  },
  {
    ...
    dateISO: "2026-08-05",
    readTime: "8 นาที",
    img: "/assets/free-online-teaching-media-cover.webp",
    alt: "รวมสื่อการสอนออนไลน์ใช้ฟรี ไม่ต้องติดตั้ง สำหรับคุณครู",
    href: "/blog/free-online-teaching-media",
    excerpt: "คัดสื่อออนไลน์สำหรับช่วงต้นคาบ ระหว่างกิจกรรม และท้ายคาบ พร้อมเกณฑ์เลือกใช้และเช็กลิสต์ก่อนฉายหน้าห้อง",
  ...
  },
  {
    ...
    dateISO: "2026-08-05",
    readTime: "8 นาที",
    img: "/assets/digital-teaching-media-cover.webp",
    alt: "สื่อการสอนดิจิทัลใช้ฟรีจาก KhunCool เพื่อห้องเรียนสนุกและจัดการง่าย",
    href: "/blog/digital-teaching-media",
    excerpt: "จับคู่ปัญหาในห้องเรียนกับเครื่องมือดิจิทัล เพื่อเพิ่มการมีส่วนร่วม จัดจังหวะกิจกรรม และลดงานซ้ำของครู",
    linksTool: { label: "เครื่องมือครู", href: "/tools" },
  },
  {
