...
export const ALL_ARTICLES: Article[] = [
  ...
  {
    title: "วิธีแบ่งกลุ่ม/จัดกลุ่มนักเรียนออนไลน์ให้เท่ากัน ใช้เครื่องมือฟรีจาก Khuncool",
    cat: "สื่อการสอน",
    date: "2 ส.ค. 2569",
    dateISO: "2026-08-02",
    readTime: "5 นาที",
    img: "/assets/group-maker-blog-cover.webp",
    alt: "วิธีแบ่งกลุ่ม/จัดกลุ่มนักเรียนออนไลน์ให้เท่ากัน",
    href: "/blog/group-maker",
    excerpt:
      "3 วิธีแบ่งกลุ่มนักเรียนให้เหมาะกับกิจกรรม ทั้งสุ่มล้วน คละความสามารถ และกำหนดจำนวนเอง พร้อมเครื่องมือแบ่งกลุ่มฟรี",
