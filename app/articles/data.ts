...
export const ALL_ARTICLES: Article[] = [
  {
    ...
    dateISO: "2026-08-02",
    readTime: "4 นาที",
    img: "/assets/ai-qa-cert-module1-cover.webp",
    alt: "ทำแบบทดสอบรับเกียรติบัตรฟรี อบรมออนไลน์ สพฐ. เรื่อง AI ประกันคุณภาพการศึกษา โมดูล 1",
    href: "/blog/ai-qa-cert-module1",
    excerpt:
      "รวมลิงก์ทำแบบทดสอบหลังเรียน อบรมออนไลน์ สพฐ. หลักสูตรการประยุกต์ใช้ AI ในการประกันคุณภาพภายในสถานศึกษา โมดูล 1 พร้อมเอกสารประกอบการอบรมและเงื่อนไขรับเกียรติบัตร",
  },
  {
