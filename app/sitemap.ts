...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/media/computer`, lastModified: now, priority: 0.9 },
    { url: `${BASE_URL}/media/computer/digital-sort`, lastModified: now, priority: 0.7 },
    { url: `${BASE_URL}/media/computer/coding-maze`, lastModified: now, priority: 0.6 },
    { url: `${BASE_URL}/media/computer/typing-defense`, lastModified: now, priority: 0.5 },
    { url: `${BASE_URL}/media/social-studies/asean-matching`, lastModified: now, priority: 0.7 },
    { url: `${BASE_URL}/media/social-studies/law-daily`, lastModified: now, priority: 0.7 },
