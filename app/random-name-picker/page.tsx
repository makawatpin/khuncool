...
const FAQS = [
  ...
  },
  {
    ...
    a: "วงล้อของขุนคูลเป็นภาษาไทยทั้งหมด ใช้งานฟรีโดยไม่ต้องสมัครสมาชิกหรือเข้าสู่ระบบ และเป็นส่วนหนึ่งของชุดเครื่องมือครูอื่น ๆ บนเว็บเดียวกัน เช่น จับเวลา แบ่งกลุ่ม และเช็กชื่อ ทำให้ครูใช้ต่อเนื่องกันได้โดยไม่ต้องสลับเว็บไซต์",
  },
];
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description: "ขั้นตอนการใช้วงล้อสุ่มชื่อออนไลน์ ตั้งแต่ใส่รายชื่อจนถึงดูผลลัพธ์",
      inLanguage: "th",
