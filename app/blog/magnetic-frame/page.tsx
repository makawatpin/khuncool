  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "รีวิวสินค้า",
          item: "https://www.khuncool.com/blog/magnetic-frame",
        },
      ],
    },
    {
...
const reasons = [
  {
    icon: "🖼️",
    head: "บอร์ดผลงานสวยเป็นระเบียบ",
    body: "แทนที่จะใช้เทปกาวแปะตรง ๆ ซึ่งดูไม่เรียบร้อยและลอกยาก กรอบแม่เหล็กช่วยให้ผลงานแต่ละชิ้นดูเป็นระบบ เปลี่ยนได้ทุกสัปดาห์โดยผนังไม่เสียหาย",
  },
  {
    icon: "🔄",
    head: "เปลี่ยนบ่อยได้ ไม่เปลืองของ",
    body: "เหมาะกับบอร์ด “ผลงานประจำสัปดาห์” หรือบอร์ดหมุนเวียนแสดงชิ้นงานเด็กแต่ละคน",
  },
  {
    icon: "🏫",
    head: "ใช้ได้หลายจุดในโรงเรียน",
    body: "ไม่ใช่แค่ในห้องเรียน แต่ใช้ติดหน้าห้องพักครู บอร์ดประชาสัมพันธ์ ป้ายตารางเวร หรือป้ายประกาศหน้าห้องธุรการก็ได้",
  },
  {
    icon: "⏱️",
    head: "ประหยัดเวลาเตรียมบอร์ด",
    body: "ไม่ต้องมานั่งเจาะ ตอกตะปู หรือแกะกาวเก่าออกทุกครั้งที่เปลี่ยนผลงาน",
  },
  {
    icon: "📋",
    head: "เหมาะกับ PLC และการประเมิน",
    body: "ใช้โชว์ผลงานเด่นของนักเรียนตอนมีการนิเทศหรือประเมินชั้นเรียนได้แบบมืออาชีพ",
  },
];
      ...
      <div className="px-4 pb-9 pt-4 md:grid md:grid-cols-[1fr_300px] md:gap-10 md:px-8 md:pt-6">
        <article className="min-w-0 md:max-w-[720px]">
          <div className="mb-3.5 flex flex-wrap items-center gap-2 md:mb-4">
            <span className="rounded-pill bg-[#FFEAD5] px-2.5 py-1 text-[12px] font-bold text-[#C2500B] md:px-[11px] md:py-[5px]">
              รีวิวสินค้า
            </span>
            ...
            <span className="text-[12px] text-ink-faint">
              26 ก.ค. 2568 · อ่าน 4 นาที · โดย ทีมคุณคูล
            </span>
          </div>

          <h1 className="m-0 mb-3 text-[26px] leading-[1.32] md:mb-4 md:text-[38px] md:leading-[1.25]">
            รีวิว กรอบป้ายติดผนังแม่เหล็ก ไม่ต้องเจาะผนัง
            ตัวช่วยทำบอร์ดและติดผลงานเด็กที่ครูต้องมี
          </h1>
          <p className="m-0 mb-5 text-base leading-[1.75] text-[#434A58] md:mb-6 md:text-[17px]">
            ครูคนไหนกำลังปวดหัวเรื่อง “ทำบอร์ดติดผลงานเด็ก” แล้วเจอปัญหาผนังพัง
            เทปกาวลอก หรือเปลี่ยนผลงานทีต้องรื้อทั้งบอร์ด
            วันนี้คุณคูลมีไอเทมตัวช่วยดี ๆ มาแนะนำ นั่นคือ{" "}
            <b>กรอบป้ายติดผนังแม่เหล็ก</b>{" "}
            ที่จะทำให้การจัดบอร์ดในห้องเรียนง่ายขึ้นอีกเยอะ
          </p>

          <h2 className="text-xl md:text-2xl">
            กรอบป้ายติดผนังแม่เหล็ก คืออะไร
          </h2>
          <p className="m-0 mb-3.5 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            กรอบป้ายติดผนังแม่เหล็กเป็นกรอบโชว์เอกสาร/ผลงาน ทำจากแผ่นใส 2
            ชั้นประกบกันด้วยแถบแม่เหล็กตรงขอบ ด้านหลังมีกาวในตัว
            ไม่ต้องเจาะผนังหรือใช้ตะปู แค่ลอกแผ่นกาวแล้วแปะติดผนัง ปูน
            หรือบอร์ดได้ทันที
          </p>
          <p className="m-0 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            จุดเด่นคือ <b>ขอบเป็นแม่เหล็ก</b>{" "}
            ทำให้สอดหรือเปลี่ยนกระดาษด้านในได้ง่าย ๆ
            แค่แงะขอบออกแล้วใส่แผ่นใหม่เข้าไป ไม่ต้องแกะกรอบทั้งอันออกจากผนัง
          </p>
          ...
          <div className="mt-3 flex flex-col gap-2 md:grid md:grid-cols-2 md:gap-[11px]">
            {highlights.map((h) => (
              ...
              >
                <span className="mt-0.5 flex h-5 w-5 flex-none items-center justify-center rounded-md bg-[#FFF1E4] text-xs font-bold text-[#C2500B] md:h-[22px] md:w-[22px]">
                  ✓
                </span>
          ...
          <div className="mt-7">
            ...
            <div className="mt-2 text-xs leading-[1.6] text-ink-faint">
              ตัวอย่างการใช้งาน คุณสมบัติ และวิธีติดตั้ง 3 ขั้นตอน ·
              ภาพจากผู้ขาย
            </div>
          </div>

          <h2 className="mt-8 text-xl md:text-2xl">
            ทำไมครูควรมีกรอบป้ายแบบนี้ติดห้องเรียน
          </h2>
          ...
          <h2 className="mt-8 text-xl md:text-2xl">
            เลือกขนาดไหนดี ให้เหมาะกับการใช้งาน
          </h2>
          <div className="mt-3 overflow-hidden rounded-2xl border border-[#E5E8EE]">
            ...
            {sizes.map((s) => (
              ...
              >
                <span className="w-11 flex-none text-sm font-bold text-[#C2500B] md:w-[90px] md:text-base">
                  {s.k}
                </span>
                <span className="flex-1 text-[13.5px] leading-[1.6] md:text-base md:font-medium">
                  {s.v}
                </span>
              </div>
            ))}
          ...
          <div className="mt-6 rounded-2xl border border-[#FFD9BA] bg-[#FFFBF6] p-4 md:p-[20px_22px]">
            <div className="mb-1.5 text-xs font-bold text-[#C2500B] md:mb-2 md:text-[13px]">
              💡 เคล็ดลับจัดบอร์ด
            </div>
            <div className="text-[13.5px] leading-[1.75] text-[#2E3440] md:text-[15px] md:leading-[1.8]">
              ถ้าจะทำบอร์ด “ผลงานเด็กทั้งห้อง” แนะนำให้ใช้กรอบ A4 เรียงเป็นแถว ๆ
              จัดวางเป็นตารางบนบอร์ด จะได้บอร์ดที่ดูเป็นระเบียบ
              เปลี่ยนผลงานรายสัปดาห์ได้ง่ายโดยไม่ต้องรื้อกรอบใหม่ทุกครั้ง
            </div>
          </div>

          <h2 className="mt-8 text-xl md:text-2xl">
            จะหาซื้อกรอบป้ายแม่เหล็กแบบนี้ได้ที่ไหน
          </h2>
          <p className="m-0 mb-4 text-[14.5px] leading-[1.78] text-[#2E3440] md:mb-[18px] md:text-[15.5px] md:leading-[1.85]">
            ตัวอย่างสินค้ากรอบป้ายติดผนังแม่เหล็ก ไม่ต้องเจาะผนัง มีกาวในตัว
            ดูรายละเอียดและสั่งซื้อได้ที่ Shopee
          </p>
          <div className="flex items-center gap-4 rounded-2xl border border-[#FFD9BA] bg-[#FFFBF6] p-4 md:p-[20px_22px]">
            <div className="flex-1">
              <div className="mb-1 text-base font-bold md:text-[16.5px]">
                กรอบป้ายติดผนัง กรอบโชว์ป้ายประกาศ แม่เหล็ก
              </div>
              <div className="text-[13.5px] text-ink-secondary">
                ไม่ต้องเจาะผนัง · มีกาวในตัว · เปิด-ปิดเปลี่ยนป้ายได้สะดวก
              </div>
            </div>
            <a
              href={shopeeUrl}
          ...
          <div className="mt-3 text-xs text-ink-faint">
            ลิงก์ร้านค้าภายนอก · ราคาและขนาดที่มีจำหน่ายอาจเปลี่ยนแปลงตามผู้ขาย
          </div>
          ...
          <div className="mt-8 border-t border-[#E5E8EE] pt-5">
            ...
            <p className="m-0 mb-4 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
              สำหรับครูที่ต้องทำบอร์ดติดผลงานเด็กอยู่บ่อย ๆ{" "}
              <b>กรอบป้ายติดผนังแม่เหล็ก</b>{" "}
              ถือเป็นอุปกรณ์คุ้มค่าที่ช่วยลดเวลาเตรียมบอร์ด
              ทำให้ผนังห้องเรียนไม่เสียหายจากการเจาะหรือแปะกาว
              และยังทำให้บอร์ดผลงานดูเป็นระเบียบมืออาชีพมากขึ้น
              เป็นอีกหนึ่งไอเทมที่คุณคูลอยากแนะนำให้ครูทุกคนลองมีติดห้องเรียนไว้สักชุด
            </p>
            <p className="m-0 mb-4 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
              ติดตามรีวิวสื่อการสอนและอุปกรณ์ห้องเรียนดี ๆ แบบนี้ได้ที่{" "}
              <Link href="/">Khuncool.com</Link> หมวดสื่อการสอน และแหล่งอบรมฟรี
              สำหรับครูไทยทุกคน
            </p>
          ...
          <div className="rounded-2xl border border-[#E5E8EE] bg-white p-4">
            ...
            <div className="flex flex-col">
              {related.map((r) => (
                ...
                >
                  <div className="mb-0.5 text-[11px] font-semibold text-[#C2500B]">
                    สื่อการสอน
                  </div>
