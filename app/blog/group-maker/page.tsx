...
export const metadata: Metadata = {
  title: "วิธีแบ่งกลุ่ม/จัดกลุ่มนักเรียนออนไลน์ให้เท่ากัน ใช้เครื่องมือฟรี | Khuncool",
  description:
    "วิธีแบ่งกลุ่มและจัดกลุ่มนักเรียนออนไลน์ให้เท่ากันและเหมาะกับกิจกรรม ทั้งแบบสุ่มล้วน คละความสามารถ และกำหนดจำนวนเอง พร้อมเครื่องมือแบ่งกลุ่มฟรีจาก Khuncool",
  alternates: {
    canonical: "https://www.khuncool.com/blog/group-maker",
  },
  openGraph: {
    type: "article",
    title: "วิธีแบ่งกลุ่ม/จัดกลุ่มนักเรียนออนไลน์ให้เท่ากัน ใช้เครื่องมือฟรี",
    description:
      "วิธีแบ่งกลุ่มและจัดกลุ่มนักเรียนให้เหมาะกับแต่ละกิจกรรม พร้อมเครื่องมือแบ่งกลุ่มฟรีจาก Khuncool",
...
const methods = [
  {
    n: "1",
    head: "สุ่มล้วน (Random)",
    body: "ใส่รายชื่อทั้งหมดแล้วให้ระบบสุ่มแบ่งกลุ่มโดยไม่กำหนดเงื่อนไข เหมาะกับกิจกรรมทั่วไปที่ต้องการความรวดเร็วและความเป็นธรรม ไม่มีใครเลือกเพื่อนเองได้",
  },
  {
    n: "2",
    head: "คละความสามารถ",
    body: "แบ่งนักเรียนออกเป็นระดับเก่ง-กลาง-อ่อนไว้ล่วงหน้า แล้วจัดให้แต่ละกลุ่มมีสมาชิกจากทุกระดับ วิธีนี้ต้องเตรียมรายชื่อแยกตามระดับก่อนแล้วค่อยสุ่มทีละระดับใส่แต่ละกลุ่ม เหมาะกับงานที่ต้องพึ่งพากันในทีม เช่น โครงงานหรือ PBL",
  },
  {
    n: "3",
    head: "กำหนดจำนวนเอง",
    body: "ระบุจำนวนกลุ่มหรือจำนวนสมาชิกต่อกลุ่มตามที่ต้องการ เช่น 4 คนต่อกลุ่มพอดี เหมาะกับกิจกรรมที่มีอุปกรณ์หรือบทบาทจำกัดตายตัว เช่น การทดลองวิทยาศาสตร์ที่มีชุดอุปกรณ์ 1 ชุดต่อกลุ่ม",
  },
];
...
const toc = [
  ...
  "3 วิธีแบ่งกลุ่ม/จัดกลุ่มให้เหมาะกับกิจกรรม",
...
const jsonLd = {
  ...
  "@graph": [
    ...
    {
      "@type": "BlogPosting",
      headline: "วิธีแบ่งกลุ่ม/จัดกลุ่มนักเรียนออนไลน์ให้เท่ากัน ใช้เครื่องมือฟรีจาก Khuncool",
      inLanguage: "th",
      ...
      <div className="px-4 pb-9 pt-4 md:grid md:grid-cols-[1fr_300px] md:gap-10 md:px-8 md:pt-6">
        <article className="min-w-0 md:max-w-[720px]">
          ...
          <h1 className="m-0 mb-3 text-[26px] leading-[1.32] md:mb-4 md:text-[38px] md:leading-[1.25]">
            วิธีแบ่งกลุ่ม/จัดกลุ่มนักเรียนออนไลน์ให้เท่ากัน ใช้เครื่องมือฟรีจาก Khuncool
          </h1>
          <p className="m-0 mb-5 text-base leading-[1.75] text-[#434A58] md:mb-6 md:text-[17px]">
            การแบ่งกลุ่มหรือจัดกลุ่มนักเรียนเป็นกิจกรรมที่ครูทุกคนต้องทำอยู่เป็นประจำ
          ...
          <h2 className="mt-8 text-xl md:text-2xl">
            3 วิธีแบ่งกลุ่ม/จัดกลุ่มนักเรียนให้เหมาะกับกิจกรรม
          </h2>
          <p className="m-0 mb-3.5 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            การแบ่งกลุ่มที่เหมาะสมขึ้นอยู่กับเป้าหมายของกิจกรรม
            ไม่ใช่ทุกครั้งที่ต้องสุ่มล้วนอย่างเดียว
            ครูสามารถเลือกวิธีจัดกลุ่มจาก 3 แบบนี้ตามลักษณะงาน
          </p>
          <div className="mt-3 flex flex-col gap-3 md:gap-3.5">
            {methods.map((m) => (
              <div key={m.n} className="flex items-start gap-3">
                <span className="mt-0.5 flex h-6 w-6 flex-none items-center justify-center rounded-lg bg-[#DFF5EF] text-[12.5px] font-bold text-[#0A7A66] md:h-[30px] md:w-[30px] md:rounded-[10px] md:text-[15px]">
                  {m.n}
                </span>
                <div>
