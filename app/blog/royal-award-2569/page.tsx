  ...
  "@graph": [
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: "ข่าวการศึกษา",
          item: "https://www.khuncool.com/blog/royal-award-2569",
        },
      ],
    },
    {
...
const timeline = [
  ...
  {
    k: "เอกสารที่ต้องศึกษา",
    v: "ประกาศ สพฐ., คู่มือประเมิน, แบบประเมิน ตามระดับสถานศึกษา",
  },
];
...
const tags = [
  "รางวัลพระราชทาน 2569",
  "สพฐ. รางวัลพระราชทาน",
  "คัดเลือกนักเรียนรางวัลพระราชทาน",
  "คัดเลือกสถานศึกษารางวัลพระราชทาน",
  "ข่าวการศึกษา 2569",
  "เกณฑ์ประเมินรางวัลพระราชทาน",
];
      ...
      <div className="px-4 pb-9 pt-4 md:grid md:grid-cols-[1fr_300px] md:gap-10 md:px-8 md:pt-6">
        <article className="min-w-0 md:max-w-[720px]">
          <div className="mb-3.5 flex flex-wrap items-center gap-2 md:mb-4">
            <span className="rounded-pill bg-[#FBF1D8] px-2.5 py-1 text-[12px] font-bold text-[#8A6206] md:px-[11px] md:py-[5px]">
              ข่าวการศึกษา
            </span>
            ...
            <span className="text-[12px] text-ink-faint">
              27 ก.ค. 2569 · อ่าน 4 นาที · โดย ทีมคุณคูล
            </span>
          </div>
          ...
          <p className="m-0 mb-5 text-base leading-[1.75] text-[#434A58] md:mb-6 md:text-[17px]">
            โรงเรียนไหนกำลังมองหาโอกาสส่งเสริมนักเรียนหรือยกระดับสถานศึกษาให้ได้รับการยอมรับระดับประเทศ
            ปีการศึกษา 2569 นี้ สพฐ. เปิดให้คัดเลือก{" "}
            <b>
              นักเรียนและสถานศึกษาเพื่อรับรางวัลพระราชทาน
              ระดับการศึกษาขั้นพื้นฐาน
            </b>{" "}
            แล้ว คุณคูลสรุปสาระสำคัญ ช่วงเวลา
            และขั้นตอนที่ครูและผู้บริหารต้องรู้มาให้แบบเข้าใจง่าย
          </p>
          ...
          <p className="m-0 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            รางวัลพระราชทานเป็นรางวัลเกียรติยศที่มอบให้แก่นักเรียน นักศึกษา
            และสถานศึกษาที่มีผลการดำเนินงานโดดเด่น
            ตามระเบียบกระทรวงศึกษาธิการว่าด้วยรางวัลพระราชทานแก่นักเรียน
            นักศึกษา และสถานศึกษา พ.ศ. 2562 โดยในระดับการศึกษาขั้นพื้นฐาน
            สำนักงานคณะกรรมการการศึกษาขั้นพื้นฐาน (สพฐ.)
            เป็นหน่วยงานรับผิดชอบหลักในการดำเนินการคัดเลือก
          </p>

          <h2 className="mt-8 text-xl md:text-2xl">
            สพฐ. สั่งเขตพื้นที่ฯ เดินหน้าคัดเลือกรอบปีการศึกษา 2569
          </h2>
          <p className="m-0 mb-3.5 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            สพฐ.
            ได้ทำหนังสือแจ้งไปยังผู้อำนวยการสำนักงานเขตพื้นที่การศึกษาทุกเขตทั่วประเทศ
            ให้ดำเนินการคัดเลือกนักเรียนและสถานศึกษาเพื่อรับรางวัลพระราชทาน
            ประจำปีการศึกษา 2569
            โดยให้ยึดตามระเบียบและหลักเกณฑ์ที่กระทรวงศึกษาธิการกำหนดไว้
            ทั้งจากประกาศหลักเกณฑ์และแนวทางการคัดเลือกฉบับลงวันที่ 17 พฤศจิกายน
            2564
          </p>
          <p className="m-0 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            พร้อมกันนี้ สพฐ.
            ยังระบุถึงมาตรการเร่งรัดการเบิกจ่ายงบประมาณและการใช้จ่ายภาครัฐ
            ประจำปีงบประมาณ 2569 เพิ่มเติม
            เพื่อให้กระบวนการคัดเลือกในรอบนี้เป็นไปด้วยความเรียบร้อยและบรรลุเป้าหมายตามกำหนดเวลา
          </p>

          <h2 className="mt-8 text-xl md:text-2xl">
            ช่วงเวลาที่ต้องรู้ สถานศึกษาสมัครได้เมื่อไหร่
          </h2>
          <p className="m-0 mb-4 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            สำนักงานเขตพื้นที่การศึกษาแต่ละแห่งมีหน้าที่ประชาสัมพันธ์ให้สถานศึกษาในสังกัดรับทราบ
            และเชิญชวนสถานศึกษาที่มีความพร้อมเสนอชื่อนักเรียนและสถานศึกษาเข้ารับการประเมิน
          </p>
          <div className="overflow-hidden rounded-2xl border border-[#E8D9A6]">
            ...
            {timeline.map((t) => (
              <div
                key={t.k}
                className="flex gap-2.5 border-t border-[#F3EBD6] p-3 first:border-t-0 md:gap-3.5 md:p-[14px_18px]"
              >
                <span className="w-24 flex-none text-xs font-bold text-[#8A6206] md:w-[150px] md:text-[14.5px] md:font-bold md:text-[#1A1D26]">
                  {t.k}
                </span>
          ...
          <p className="m-0 mt-4 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            หลังจากนั้นสำนักงานเขตพื้นที่การศึกษาจะดำเนินการคัดเลือกต่อไปตามประกาศ
            หลักเกณฑ์ และกรอบเวลาที่กระทรวงศึกษาธิการกำหนด
          </p>

          <h2 className="mt-8 text-xl md:text-2xl">
            เตรียมตัวอย่างไร โรงเรียนควรดูเอกสารอะไรบ้าง
          </h2>
          <p className="m-0 mb-3.5 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            ก่อนยื่นสมัคร
            แนะนำให้ผู้บริหารและครูที่รับผิดชอบศึกษารายละเอียดหลักเกณฑ์การประเมินให้ครบถ้วน
            โดยสามารถดูข้อมูลเพิ่มเติมได้จาก
          </p>
          ...
          <p className="m-0 mt-4 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            เนื่องจากเกณฑ์การประเมินแยกตามระดับชั้นและประเภทสถานศึกษา
            ครูควรตรวจสอบให้ตรงกับระดับที่โรงเรียนของตนเปิดสอน
            เพื่อเตรียมหลักฐานและข้อมูลประกอบการประเมินได้อย่างครบถ้วน
          </p>

          <h2 className="mt-8 text-xl md:text-2xl">งบประมาณสนับสนุน</h2>
          <p className="m-0 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
            สพฐ.
            ยังได้จัดสรรงบประมาณเพื่อสนับสนุนการดำเนินการคัดเลือกในระดับเขตพื้นที่การศึกษา
            พร้อมขอให้แต่ละเขตดำเนินการในส่วนที่เกี่ยวข้องให้แล้วเสร็จตามกรอบเวลา
            เพื่อให้การคัดเลือกเป็นไปอย่างถูกต้อง โปร่งใส
            และสะท้อนคุณภาพที่แท้จริงของผู้เรียนและสถานศึกษา
          </p>

          <div className="mt-8 border-t border-[#E5E8EE] pt-5">
            <h2 className="text-lg md:text-[22px]">บทสรุป</h2>
            <p className="m-0 mb-4 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
              การคัดเลือกรางวัลพระราชทานปีการศึกษา 2569
              ถือเป็นโอกาสสำคัญที่โรงเรียนจะได้แสดงศักยภาพและยกระดับชื่อเสียงในระดับประเทศ
              โรงเรียนที่สนใจควรรีบตรวจสอบคุณสมบัติและเตรียมเอกสารให้พร้อม
              ก่อนยื่นความจำนงกับสำนักงานเขตพื้นที่การศึกษาภายในกรอบเวลาที่กำหนด
              คือ <b>1–21 สิงหาคม 2569</b>
            </p>
            <p className="m-0 mb-4 text-[14.5px] leading-[1.78] text-[#2E3440] md:text-[15.5px] md:leading-[1.85]">
              คุณคูลจะติดตามความเคลื่อนไหวข่าวการศึกษาที่เป็นประโยชน์ต่อครูและโรงเรียนมาอัปเดตให้เรื่อย
        ...
        <aside className="mt-8 flex flex-col gap-4 md:mt-0">
          <div className="rounded-2xl border border-[#E8D9A6] bg-[#FFFCF3] p-4 md:sticky md:top-5">
            <div className="mb-3 text-[13px] font-bold text-[#8A6206]">
              สรุปสั้น
            </div>
            ...
            <div className="mt-4 border-t border-[#F0E4C2] pt-3.5">
              <div className="mb-1 text-[11.5px] font-bold text-[#8A6206]">
                ช่วงยื่นความจำนง
              </div>
