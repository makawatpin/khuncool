...
export default function AseanFlag({ code }: { code: string }) {
  ...
  if (code === "PH") return <svg {...p}><path fill="#0038a8" d="M0 0h60v20H0z"/><path fill="#ce1126" d="M0 20h60v20H0z"/><path fill="#fff" d="M0 0l30 20L0 40z"/><circle cx="10.5" cy="20" r="3.2" fill="#fcd116"/><g stroke="#fcd116" strokeWidth="1">{Array.from({length:8},(_,i)=><path key={i} d={`M10.5 20l${10.5+Math.cos(i*Math.PI/4)*6} ${20+Math.sin(i*Math.PI/4)*6}`}/>)}</g><g fill="#fcd116"><polygon points={starPoints(3.8,5,2.1,.85)}/><polygon points={starPoints(3.8,35,2.1,.85)}/><polygon points={starPoints(25,20,2.1,.85)}/></g></svg>;
