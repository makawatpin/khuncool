...
export default function SocialStudiesPage() {
  return <main className="flex-1 w-full max-w-[1160px] mx-auto bg-white">
    ...
    <div className="px-4 pb-[22px] pt-3 md:grid md:grid-cols-[1.15fr_0.85fr] md:items-start md:gap-11 md:px-8 md:pb-[30px] md:pt-4">
      ...
      <div className="mt-6 hidden rounded-card-lg border border-border bg-surface-light p-[20px_22px] md:block"><h2 className="m-0 mb-2.5 text-[15px]">สื่อชิ้นแรกที่กำลังพัฒนา</h2><div className="flex items-center gap-[13px] rounded-2xl border border-border bg-surface-card p-3.5"><div className="flex h-12 w-12 flex-none items-center justify-center rounded-2xl bg-[#E7F0FF] text-[23px]">🌏</div><div className="min-w-0 flex-1"><h3 className="m-0 mb-0.5 text-[15.5px]">เกมจับคู่ภาพอาเซียน</h3><p className="m-0 text-[12.5px] text-ink-secondary">5 หมวด · ป.4–ป.6</p></div><span className="flex-none text-[13px] font-semibold text-[#8A6A00]">กำลังทำ</span></div></div>
    </div>
