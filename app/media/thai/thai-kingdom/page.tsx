...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", title: TITLE, description: DESCRIPTION, url: PAGE_URL, siteName: "khuncool", locale: "th_TH", images: [{ url: "/assets/thai-kingdom/thai-kingdom-cover.png", width: 1536, height: 1024, alt: "อาณาจักรภาษาไทย อ่านออก เขียนได้" }] },
  twitter: { card: "summary_large_image", title: TITLE, description: DESCRIPTION },
};

const jsonLd = { "@context": "https://schema.org", "@type": "LearningResource", name: "อาณาจักรภาษาไทย: อ่านออก เขียนได้", url: PAGE_URL, inLanguage: "th-TH", educationalLevel: "ประถมศึกษาปีที่ 1", learningResourceType: "Interactive educational game", teaches: ["พยัญชนะไทย", "สระ “า” สระ “◌ี” สระ “◌ู”", "การประสมคำไม่มีตัวสะกด"], isAccessibleForFree: true };
