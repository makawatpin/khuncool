...
export const SUBJECT_CONTENT: Record<"mathematics" | "science" | "thai", SubjectPageContent> = {
  mathematics: {
    ...
    educationalLevel: "ประถมศึกษาปีที่ 1–6", updated: "2026-08-24",
  ...
  thai: {
    ...
    educationalLevel: "ประถมศึกษาปีที่ 1", updated: "2026-08-24",
    headline: "เกมและสื่อการสอนภาษาไทย อ่านคล่อง เขียนสื่อความ",
    intro: "สื่อการสอนภาษาไทยสำหรับพัฒนาการอ่านและหลักภาษา เริ่มจากพยัญชนะ ตำแหน่งสระ และการประสมคำไม่มีตัวสะกดสำหรับ ป.1 ผ่านภาพ เสียงอ่าน เกมรถไฟเก็บคำ และแบบทดสอบ ออกแบบสำหรับใช้บนจอหน้าชั้นเรียนและโทรศัพท์มือถือ",
    topics: ["พยัญชนะไทย", "ตำแหน่งสระ", "ประสมคำ", "อ่านออกเสียง", "การเขียน"],
    resources: [
