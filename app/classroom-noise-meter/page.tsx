...
const HOWTO_STEPS = [
  ...
  {
    name: "ดูสถานะจากค่าเฉลี่ยเสียง",
    text: "หน้าจอใช้ค่าเฉลี่ยเสียงย้อนหลัง 2 วินาทีเพื่อลดการแกว่ง พร้อมแสดงสีและอีโมจิเมื่อเสียงใกล้ถึงหรือเกินเกณฑ์",
  },
  {
  ...
  },
  {
    ...
    text: "ตั้งระดับเสียงที่ยอมรับได้และเลือกระยะเวลาที่ต้องดังเกินต่อเนื่องก่อนนับ ระบบจะแสดงจำนวนครั้งและเวลาที่ดังเกินรวม",
  },
];
